"""deleverio_16078 URL Configuration
...
admin.site.site_header = "deleverio"
admin.site.site_title = "deleverio Admin Portal"
admin.site.index_title = "deleverio Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="deleverio API",
        default_version="v1",
        description="API documentation for deleverio App",
    ),
    public=True,
